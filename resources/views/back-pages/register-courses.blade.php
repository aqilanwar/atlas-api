            ...
            <div class="col-md-6">
                ...
                <div class="card mt-10">
                    ...
                    <div class="card-body p-9">
                        <div class="row mb-8">
                            <h4 class="fw-bolder">Please select the courses that you want : </h4>
                        </div>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="row">
                                            <!--begin::Label-->
                                            <label class="col fw-bold mx-3"> Matematik Tambahan</label>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Row-->
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="row">
                                            <!--begin::Label-->
                                            <label class="col fw-bold mx-3">Bahasa Melayu</label>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Row-->
                                    </td>
