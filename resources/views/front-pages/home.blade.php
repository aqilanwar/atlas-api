  ...
  <main id="main">
    ...
    <section id="team" class="team section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Pasukan pendidik kami yang berkualiti tinggi dan berpengalaman akan bekerjasama dengan anda untuk mengenal pasti kekuatan dan kelemahan anda, dan menyediakan rancangan pembelajaran yang sesuai dengan keperluan dan matlamat anda.</h2>
          <p>Samada anda memerlukan bantuan dalam subjek tertentu atau ingin meningkatkan gred keseluruhan anda, kami mempunyai kepakaran dan sumber yang diperlukan untuk menyokong anda.</p>
        </div>
    ...
    <section id="contact" class="contact section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Jangan biarkan kesulitan akademik anda menghalang anda lagi ! </h2>
          <p>Hubungi kami hari ini untuk menjadualkan konsultasi dan ambil langkah pertama menuju kejayaan akademik.</p>
        </div>
