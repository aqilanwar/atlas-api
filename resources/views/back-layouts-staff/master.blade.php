		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					@include('back-layouts-staff/navbar')
					@include('back-layouts-staff/toolbar')
					<!--begin::Container-->
					<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
						...
						<div class="content flex-row-fluid" id="kt_content">
							...
							<div class="d-flex flex-column flex-xl-row">
								@include('back-layouts-staff/sidebar')
								@yield('content')
							</div>
							<!--end::Layout - Overview-->
						</div>
					...
					<!--end::Container-->
					@include('back-layouts-staff/footer')
				</div>
				<!--end::Wrapper-->
			</div>
			<!--end::Page-->
			...
			<div class="modal-dialog mw-650px">
				...
				<div class="modal-content">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						...
						<input class="form-control form-control-solid mb-8" placeholder="Enter your full name">
						<!--end::Input fills-->

						<!--start::Input fills-->
						<label for="form-control">Email: </label>
						<input class="form-control form-control-solid mb-8" placeholder="Type or paste emails here">
						<!--end::Input fills-->
					...
					<!--end::Heading-->
						...
						<input class="form-control form-control-solid mb-8" placeholder="Enter your parent's full name">
						<!--end::Input fills-->

						<!--start::Input fills-->
						<label class="fs-6">Parent's phone number</label>
						<input class="form-control form-control-solid mb-8" placeholder="Enter your parent's phone number">
						<!--end::Input fills-->

						<!--start::Input fills-->
						<label class="fs-6">Parent's email address</label>
						<input class="form-control form-control-solid mb-8" placeholder="Enter your parent's email address">
						<!--end::Input fills-->
						
						<!--begin::Wrapper-->
						<div class="float-end">
							<button type="button" class="btn btn-lg btn-light-primary">Save</button>
						</div>
						<!--end::Wrapper-->
